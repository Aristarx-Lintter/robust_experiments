...
Also, Conv2dStaticSamePadding from [EfficientNet-PyTorch](https://github.com/lukemelas/EfficientNet-PyTorch) does not perform like TensorFlow, the padding strategy is different. So I implement a real tensorflow-style [Conv2dStaticSamePadding](src/efficientnet/utils_extra.py#L9) and [MaxPool2dStaticSamePadding](src/efficientnet/utils_extra.py#L55) myself.
